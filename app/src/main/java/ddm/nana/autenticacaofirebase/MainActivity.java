package ddm.nana.autenticacaofirebase;
                        ...
                        .addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    // Criou e logou com sucesso.
                                    // Exibe mensagem em lblEstado:
                                    lblEstado.setText("Usuário logado c/ sucesso" + usuarios.getCurrentUser().getEmail());
                                } else {
                                    // Não conseguiu criar o usuário.
                                    // Exibe mensagem em lblEstado:
                                    lblEstado.setText("Falha ao logar o usuario!");
